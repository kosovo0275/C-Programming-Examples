...
int main(void) {
	...
	// create a file w+b mode, probably in /data/data/com.termux/files/usr/tmp.  File will
	...
	char tfile[] = "/data/data/com.termux/files/usr/tmp/my-temp-file-XXXXXX";
	...
	// int fd = mkstemp("/data/data/com.termux/files/usr/tmp/my-tmp-file-XXXXXX"); 
