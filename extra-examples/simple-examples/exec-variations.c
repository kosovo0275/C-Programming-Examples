...
int main(void) {
	...
	if(version == 0) {
		 ...
		 */
		char *envp[] = { "HOME=/data/data/com.termux/files/home", "ANDROID_DATA=/data", "ANDROID_ROOT=/system", NULL };
		
		// Note "ls ~" means list your home directory, but we have
		// changed the meaning of the home directory by changing the
		// environment variable.
		execle("/data/data/com.termux/files/usr/bin/ls", "ls", "~", NULL, envp);
	}
	else if(version == 3) {
		...
		char *argv[] = { "ls", 
		                 ...
		                 "-a",
		                 NULL };
		execv("/data/data/com.termux/files/usr/bin/ls", argv);
	}
	...
	*/
		...
		char *argv[] = {"ls", "-l", NULL};
		char *envp[] = { "HOME=/data/data/com.termux/files/home", "ANDROID_DATA=/data", "ANDROID_ROOT=/system", NULL };
		execve("/data/data/com.termux/files/usr/bin/ls", argv, envp);
	}
